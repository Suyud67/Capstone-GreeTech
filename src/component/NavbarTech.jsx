...
export default function Navbar() {
  ...
  return (
    <header
      className="absolute top-0 left-0 z-10 flex w-full items-center bg-transparent text-black"
      id="navbar"
    >
      <div className="container">
        <div className="relative flex items-center justify-between text-lg font-bold">
          ...
          <div className="flex items-center xl:max-w-full">
            <HamburgerTech />
            <nav
              className="absolute right-4 top-full hidden w-full max-w-[250px] rounded-lg bg-white py-5 shadow-lg lg:static lg:block lg:max-w-full lg:bg-transparent lg:shadow-none"
              id="nav-menu"
            >
